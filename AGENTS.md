...
本项目是“智安护居——多模态居家老人智能风险防控平台”（CareShield），服务于老年人跌倒风险评估、实时跌倒检测和诈骗风险识别研究。M0–M6 已完成基础工程、Web 平台、真实 EZVIZ 媒体链、统一实时结果管道、真实 GPU 跌倒检测和跌倒风险研究链；M7 建设隔离的实时音频诈骗识别 Worker。
